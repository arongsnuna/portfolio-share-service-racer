...
class educationService {
    ...
    static async createEducation({ userId, newEducation }) {
        ...
        const createdEducation = await Education.create({userId, eduSchool, eduMajor, eduEnterDate, eduGraduateDate, eduDegree })
    ...
    static async updateEducation({ userId, educationId, newEducation }) {
        const {eduSchool, eduMajor, eduEnterDate, eduGraduateDate, eduDegree} = newEducation;
        const updatedEducation = await Education.update({userId, educationId, eduSchool, eduMajor, eduEnterDate, eduGraduateDate, eduDegree });
