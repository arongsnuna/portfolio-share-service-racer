                ...
                <div key={item.id}>
                    {item.isSave === true && item.isEdit === false ? (
                        ...
                        <div>
                            ...
                            <div className='mb-2'>
                                <Form.Control style={{ width: '100%' }} type='date' placeholder='전공' value={eduMajor} onChange={onChangeMajor} />
                            </div>
                            <div className='mb-2'>
                                <Form.Control
                                    style={{ width: '100%' }}
                            ...
                            <div className='mb-2'>
                                <Form.Control style={{ width: '100%' }} type='date' placeholder='학위' value={eduDegree} onChange={onChangeDegree} />
                            </div>
